...
GC_604 = Coupling(name = 'GC_604',
                  value = '(ctGI*complex(0,1)*G*G*vev)/(Lambda**2*cmath.sqrt(2))',
                  order = {'DIM6':1,'QCD':2})
...
GC_833 = Coupling(name = 'GC_833',
                  value = '-((ctG*G*G)/(Lambda**2*cmath.sqrt(2)))',
                  order = {'DIM6':1,'QCD':2})
...
GC_842 = Coupling(name = 'GC_842',
                  value = '-((ctWI*ee)/(Lambda**2*sw*cmath.sqrt(2))) - (ctW*ee*complex(0,1))/(Lambda**2*sw*cmath.sqrt(2))',
                  order = {'DIM6':1,'QED':2})
...
GC_854 = Coupling(name = 'GC_854',
                  value = '-((cbWI*ee)/(Lambda**2*sw*cmath.sqrt(2))) - (cbW*ee*complex(0,1))/(Lambda**2*sw*cmath.sqrt(2))',
                  order = {'DIM6':1,'QED':2})
